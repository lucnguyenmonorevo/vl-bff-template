...
// 	protoc        v3.21.12
// source: proto/account/aggregates/example/use_case/permission_verify.proto
...
func (x *PermissionVerifyUseCaseRequest) Reset() {
	*x = PermissionVerifyUseCaseRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_account_aggregates_example_use_case_permission_verify_proto_msgTypes[0]
...
func (*PermissionVerifyUseCaseRequest) Descriptor() ([]byte, []int) {
	return file_proto_account_aggregates_example_use_case_permission_verify_proto_rawDescGZIP(), []int{0}
}
...
type PermissionVerifyUseCaseRequestData struct {
	...
	OrchestratorFunctionId uint64 `protobuf:"varint,6,opt,name=orchestrator_function_id,json=orchestratorFunctionId,proto3" json:"orchestrator_function_id,omitempty"`
...
func (x *PermissionVerifyUseCaseRequestData) Reset() {
	*x = PermissionVerifyUseCaseRequestData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_account_aggregates_example_use_case_permission_verify_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PermissionVerifyUseCaseRequestData) Descriptor() ([]byte, []int) {
	return file_proto_account_aggregates_example_use_case_permission_verify_proto_rawDescGZIP(), []int{1}
}

func (x *PermissionVerifyUseCaseRequestData) GetFunctionId() uint64 {
	if x != nil {
		return x.FunctionId
	}
	return 0
...
func (x *PermissionVerifyUseCaseRequestData) GetPageId() uint64 {
	if x != nil {
		return x.PageId
	}
	return 0
...
func (x *PermissionVerifyUseCaseRequestData) GetOrganizationId() uint64 {
	if x != nil {
...
func (x *PermissionVerifyUseCaseRequestData) GetUserId() uint64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *PermissionVerifyUseCaseRequestData) GetOrchestratorFunctionId() uint64 {
	if x != nil {
...
func (x *PermissionVerifyUseCaseResponse) Reset() {
	*x = PermissionVerifyUseCaseResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_account_aggregates_example_use_case_permission_verify_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PermissionVerifyUseCaseResponse) Descriptor() ([]byte, []int) {
	return file_proto_account_aggregates_example_use_case_permission_verify_proto_rawDescGZIP(), []int{2}
}
...
var File_proto_account_aggregates_example_use_case_permission_verify_proto protoreflect.FileDescriptor

var file_proto_account_aggregates_example_use_case_permission_verify_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x2f, 0x75, 0x73, 0x65, 0x5f, 0x63, 0x61, 0x73, 0x65, 0x2f, 0x70, 0x65, 0x72, 0x6d,
	...
	0x65, 0x2e, 0x75, 0x73, 0x65, 0x5f, 0x63, 0x61, 0x73, 0x65, 0x2e, 0x50, 0x65, 0x72, 0x6d, 0x69,
	...
	0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x0a, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x70,
	0x61, 0x67, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x70, 0x61,
	...
	0x01, 0x28, 0x04, 0x52, 0x16, 0x6f, 0x72, 0x63, 0x68, 0x65, 0x73, 0x74, 0x72, 0x61, 0x74, 0x6f,
	...
	0x2f, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2f, 0x75, 0x73, 0x65, 0x5f, 0x63, 0x61, 0x73,
	0x65, 0x3b, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x75, 0x73,
	0x65, 0x63, 0x61, 0x73, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_proto_account_aggregates_example_use_case_permission_verify_proto_rawDescOnce sync.Once
	file_proto_account_aggregates_example_use_case_permission_verify_proto_rawDescData = file_proto_account_aggregates_example_use_case_permission_verify_proto_rawDesc
)

func file_proto_account_aggregates_example_use_case_permission_verify_proto_rawDescGZIP() []byte {
	file_proto_account_aggregates_example_use_case_permission_verify_proto_rawDescOnce.Do(func() {
		file_proto_account_aggregates_example_use_case_permission_verify_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_account_aggregates_example_use_case_permission_verify_proto_rawDescData)
	})
	return file_proto_account_aggregates_example_use_case_permission_verify_proto_rawDescData
}

var file_proto_account_aggregates_example_use_case_permission_verify_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_account_aggregates_example_use_case_permission_verify_proto_goTypes = []interface{}{
	(*PermissionVerifyUseCaseRequest)(nil),     // 0: account.aggregates.example.use_case.PermissionVerifyUseCaseRequest
	(*PermissionVerifyUseCaseRequestData)(nil), // 1: account.aggregates.example.use_case.PermissionVerifyUseCaseRequestData
	(*PermissionVerifyUseCaseResponse)(nil),    // 2: account.aggregates.example.use_case.PermissionVerifyUseCaseResponse
...
var file_proto_account_aggregates_example_use_case_permission_verify_proto_depIdxs = []int32{
	3, // 0: account.aggregates.example.use_case.PermissionVerifyUseCaseRequest.transaction:type_name -> common.messaging.Transaction
	4, // 1: account.aggregates.example.use_case.PermissionVerifyUseCaseRequest.client:type_name -> common.messaging.Client
	1, // 2: account.aggregates.example.use_case.PermissionVerifyUseCaseRequest.data:type_name -> account.aggregates.example.use_case.PermissionVerifyUseCaseRequestData
	3, // 3: account.aggregates.example.use_case.PermissionVerifyUseCaseResponse.transaction:type_name -> common.messaging.Transaction
	5, // 4: account.aggregates.example.use_case.PermissionVerifyUseCaseResponse.error:type_name -> common.messaging.Error
...
func init() { file_proto_account_aggregates_example_use_case_permission_verify_proto_init() }
func file_proto_account_aggregates_example_use_case_permission_verify_proto_init() {
	if File_proto_account_aggregates_example_use_case_permission_verify_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_proto_account_aggregates_example_use_case_permission_verify_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_account_aggregates_example_use_case_permission_verify_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_account_aggregates_example_use_case_permission_verify_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_account_aggregates_example_use_case_permission_verify_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_account_aggregates_example_use_case_permission_verify_proto_goTypes,
		DependencyIndexes: file_proto_account_aggregates_example_use_case_permission_verify_proto_depIdxs,
		MessageInfos:      file_proto_account_aggregates_example_use_case_permission_verify_proto_msgTypes,
	}.Build()
	File_proto_account_aggregates_example_use_case_permission_verify_proto = out.File
	file_proto_account_aggregates_example_use_case_permission_verify_proto_rawDesc = nil
	file_proto_account_aggregates_example_use_case_permission_verify_proto_goTypes = nil
	file_proto_account_aggregates_example_use_case_permission_verify_proto_depIdxs = nil
}
